//for demo purpose only, not neccessary for a real app
  ...
  return {
    amd:{
     ...
     log:function(msg,date){
       ...
       preInit:function(){
        var locale=location.search.split('=')[1];
        if(locale){decj.setLocale(locale);}//for demo purpose only, not neccessary for a real app
       },
